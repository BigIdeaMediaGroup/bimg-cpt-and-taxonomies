...
class KOCHPress {
    ...
    {
        add_action( 'init', array( $this, 'create_press_post_type' ) );
    }
     ...
     */
    public function create_press_post_type() {
        $labels = array(
            'name' => 'Press Release',
            'singular_name' => 'Press Release',
            // 'menu_name' => '', // Defaults to the value of 'name'
            // 'name_admin_bar => '', // Defaults to the value of 'singular_name'
            'all_items' => 'All Press Releases', // Defaults to the value of 'name'
            // 'add_new' => '', // Default: 'Add New'
            'add_new_item' => 'Add New Press Release', // Default: 'Add New Post/Page'
            'edit_item' => 'Edit Press Release', // Default: 'Edit Post/Page'
            'new_item' => 'New Press Release', // Default: 'New Post/Page'
            'view_item' => 'View Press Release', // Default: 'View Post/Page'
            'search_items' => 'Search Press Release', // Default: 'Search Posts/Pages'
            'not_found' => 'No Press Release found', // Default: 'No posts/pages found'
            'not_found_in_trash' => 'No Press Release found in Trash', // Default: 'No posts/pages found in Trash.'
        ...
        $rewrite = array(
            'slug' => 'press_release', // Defaults to $post_type
        ...
        $args = array(
            ...
            'labels' => $labels,
            'description' => 'For adding new Press Releases.', // string
            'public' => true, // boolean
        ...
        register_post_type( 'koch_press', $args );
    }
}
